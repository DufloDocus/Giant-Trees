...
public class Build {
    ...
    public Location changeBlock(Location loc, double shiftX, double shiftY, double shiftZ, Material material) {
        ...
        try {
            ...
            GiantTrees.logSevere("Problem changing block!");
            e.printStackTrace();
            return location;
        }
    }
    ...
    /**
     * Changes the block/adds the block to the blocklist and hashset Will change
     * block regardless of hashset
     *
     * @param loc location of the block
     * @param shiftX x change to block location
     * @param shiftY y change to block location
    ...
    public Location changeBlockForce(Location loc, double shiftX, double shiftY, double shiftZ, Material material) {
        ...
        try {
            ...
            GiantTrees.logSevere("Problem force changing block!");
            e.printStackTrace();
            return location;
        }
    }
    ...
    /**
     * Changes the block/adds the block to the blocklist and hashset Will only
     * change block if not in hashset and the block being changed is air
     *
     * @param loc location of the block
     * @param shiftX x change to block location
     * @param shiftY y change to block location
    ...
    public Location addBlock(Location loc, double shiftX, double shiftY, double shiftZ, Material material) {
        ...
        try {
            ...
            GiantTrees.logSevere("Problem adding block!");
            e.printStackTrace();
            return location;
        }
    }
