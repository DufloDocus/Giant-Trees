...
public class MetaData {
    ...
    private final int[] bannedList = {0, 6, 26, 27, 28, 31, 32, 34, 36, 37, 38, 39, 40, 50, 55, 59, 63, 64, 65, 66, 68, 69, 70, 71, 72, 75, 76, 77, 78, 81, 83, 85, 90, 93, 94, 96};
    private final int[] dangerousList = {7, 8, 9, 10, 11, 12, 13, 23, 29, 33, 44, 46, 51, 52, 53, 54, 67, 79};

    /**
     * Holds the metadata/material for a tree Spruce, birch, or oak Or a block
     * ID
     *
     * @param logt log type
    ...
    /**
     * Int type of metadata for a given type (spruce, birch, oak) 0 for none
     *
     * @param s type
    ...
    /**
     * Sees if an int is in an int array Used for checking dangerous blocks /
     * banned blocks
     *
     * @param type the int
