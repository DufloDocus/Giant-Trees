...
public class FileHandler {
    ...
    public String[] read(String location){
        ...
        try{
            ...
            GiantTrees.logSevere("Cannot read file: " + folder + location);
            e.printStackTrace();
            return null;
        }
    }
    ...
    public void write(String[] data, String location){
        ...
        try{
            ...
            GiantTrees.logSevere("Cannot write to file: " + folder + location);
            e.printStackTrace();
        }
    }
    /**
    ...
    public void delete(String location){
        ...
        if(!success){
            GiantTrees.logWarning("Unable to delete: " + folder + location);
        }
    }
    /**
    ...
    public String[] readFromArchive(String location){
        ...
        try{
            ...
            GiantTrees.logSevere("Could not extract file from archive: " + folder + location);
            e.printStackTrace();
            return null;
        }
    }
    ...
    private void createZipFile(String zipLocation, String fileLocation){
        ...
        try{
            ...
            GiantTrees.logSevere("Could not create archive: " + folder + zipLocation);
            e.printStackTrace();
        }
    }
    /**
    ...
    private int getZipSize(String path){
        ...
        try{
            ...
            GiantTrees.logSevere("Problem getting zip size!");
            e.printStackTrace();
            return -1;
        }
    }
